...
describe('Story 1: marks average', () => {
  it("UAT1.1: When the marks are [9,9,9] Then I Should see [9.0, {'a': 0, 'h': 3, 'l': 0}, 'They did well']", () => {
    expect(testsResults([9, 9, 9])).toEqual([9.0, {"a": 0, "h": 3, "l": 0},  'They did well']);
  });
...
describe('Story 2: dictionary/hash with keys "h", "a", "l"', () => {
  ...
  it("UAT2.3: When the marks are [9,9,10] Then I Should see [9.333, {'h': 3, 'a': 0, 'l': 0}, 'They did well']", () => {
    expect(testsResults([9, 9, 10])).toEqual([9.333, {'h': 3, 'a': 0, 'l': 0}, 'They did well']);
  });
